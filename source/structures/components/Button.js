...
module.exports = class Button {
	...
	setStyle(style) {
		switch (style.toUpperCase()) {
			case 'BLUE':
				return (this.style = Constants.ButtonStyles.PRIMARY);
			case 'GRAY':
				return (this.style = Constants.ButtonStyles.SECONDARY);
			case 'GREEN':
				return (this.style = Constants.ButtonStyles.SUCCESS);
			case 'RED':
				return (this.style = Constants.ButtonStyles.DANGER);
			case 'LINK':
				return (this.style = Constants.ButtonStyles.LINK);
			default:
